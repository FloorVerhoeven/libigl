...
IGL_INLINE void igl::opengl::ViewerCore::draw_two_buffers(ViewerData& data,
                                                          ViewerData& data2,
                                                          bool update_matrices,
                                                          Eigen::Matrix<unsigned char,Eigen::Dynamic,Eigen::Dynamic>& R,
                                                          Eigen::Matrix<unsigned char,Eigen::Dynamic,Eigen::Dynamic>& G,
...
IGL_INLINE void igl::opengl::ViewerCore::draw_three_buffers(ViewerData& data,
                                                            ViewerData& data2,
                                                            ViewerData& data3,
                                                            bool update_matrices,
                                                            Eigen::Matrix<unsigned char,Eigen::Dynamic,Eigen::Dynamic>& R,
...
IGL_INLINE void igl::opengl::ViewerCore::draw_labels(
  ...
  float render_scale = orthographic ? 1.1 : 4.7;// 0.6 : 1.7;
